...
var asdasd = function(id) {
    ...
    var compile = function () {
        ...
        elem = document.getElementById("ts-alius");
        ...
        var compilationReadyEvent;
        
        if (document.createEvent) {
            compilationReadyEvent = document.createEvent("HTMLEvents");
            compilationReadyEvent.initEvent("CompilationReady", true, true);
        } else {
            compilationReadyEvent = document.createEventObject();
            compilationReadyEvent.eventType = "CompilationReady";
        }
    
        compilationReadyEvent.eventName = "CompilationReady";
    
        if (document.createEvent) {
            document.dispatchEvent(compilationReadyEvent);
        } else {
            document.fireEvent("on" + compilationReadyEvent.eventType, compilationReadyEvent);
        }
    };
